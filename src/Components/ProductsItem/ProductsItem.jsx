...
export default function ProductsItem({ prodItem , hideWishLogo}) {
    ...
    return (
        <>
            <div className='product-item  col-xl-3 col-lg-4 col-md-6'>
                <div className="inner h-100 d-flex flex-column justify-content-between" onClick={changeId}>
                    <div className="header mb-3">
                        <img src={imageCover} className=' w-100 rounded mb-2' alt="" />
                        <h2 className='category h6 text-capitalize'>{category.name}</h2>
                    ...
                    <div className="footer">
                        ...
                        <div className=' d-flex align-items-center'>
                            <button className='btn position-relative z-0' onClick={(event) => clickToAdd(event, _id)}>
                            ...
                            {hideWishLogo?<button className='btn-remove btn btn-danger position-relative z-0 ms-auto' onClick={(event)=>{mutateRemove(_id); event.stopPropagation()}}>
                            ...
                            !hideWishLogo?
                            <i className="fa-solid fa-heart ms-auto" style={{color : wishlisted?'#2eb92e':'#b0b0b0', cursor: 'pointer'}} title='add to wishlist' onClick={(event)=>{mutateWishlist(_id); event.stopPropagation()}}/>
                            :''
                            }
