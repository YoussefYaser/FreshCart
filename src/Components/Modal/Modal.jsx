...
export default function ModalPayment({button, cartId}) {
    ...
    return (
        <>
            <Button className='btn-online me-3' variant="primary" onClick={handleShow}>
                Pay {button}
            </Button>
            ...
            <Modal show={show} onHide={handleClose} className='modal'>
                ...
                <Modal.Body>
                    <form action="" onSubmit={formik.handleSubmit}>
                        ...
                        <input type="text" className=' form-control mb-3' id="details" onChange={formik.handleChange} />

                        <label htmlFor="phone">City</label>
                        <input type="text" className=' form-control mb-3' id="phone"  onChange={formik.handleChange}/>
                        
                        <label htmlFor="city">Phone</label>
                        <input type="text" className=' form-control' id="city"  onChange={formik.handleChange} />  
                        
                        <Modal.Footer className=' mt-4 py-2 px-0'>
                            <button  type='submit' className='btn-submit p-2' >
                                Submit
                            </button>
                        </Modal.Footer>
